...
const Payment = ({ onPaymentSuccess }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://job-b-jlk3.onrender.com/order', {
        sender,
        receiver,
        amount,
      });
      ...
      const razorPayOptions = {
        ...
        handler: async (response) => {
          ...
          try {
            const paymentResponse = await axios.post('https://job-b-jlk3.onrender.com/payment-success', {
              sender,
              receiver,
              amount,
              razorpayPaymentId,
