...
const Payment = ({ onPaymentSuccess }) => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      try {
        const response = await axios.get('https://job-searching-backend-phpz.onrender.com/transactions');
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://job-searching-backend-phpz.onrender.com/order', {
        sender,
        receiver,
        amount,
      });
      ...
      const razorPayOptions = {
        ...
        handler: async (response) => {
          ...
          try {
            const paymentResponse = await axios.post('https://job-searching-backend-phpz.onrender.com/payment-success', {
              sender,
              receiver,
              amount,
              razorpayPaymentId,
