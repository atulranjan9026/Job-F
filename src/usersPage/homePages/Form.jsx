...
function KNNApp({ moveToResultPage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch("https://job-b-jlk3.onrender.com/data", {
          method: "POST",
          headers: {
    ...
    try {
      ...
      const response2 = await fetch("https://job-b-jlk3.onrender.com/search", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      // Seeker table data
      const response3 = await fetch("https://job-b-jlk3.onrender.com/seeker", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
