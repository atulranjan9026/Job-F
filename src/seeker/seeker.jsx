...
const handleAcceptJob = async (email, salary, name, userId ,userEmail) => {
  try {
    const response = await axios.post(
      "https://job-searching-backend-phpz.onrender.com/accept",
...
//         `https://job-searching-backend-phpz.onrender.com/reqbooking/${email}`
//       );
...
// }, [email]); // Include email in the dependency array
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://job-searching-backend-phpz.onrender.com/seeker/${email}`
        );
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const response = await axios.get(`https://job-searching-backend-phpz.onrender.com/reviews/${id}`);
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        const response = await axios.get(`https://job-searching-backend-phpz.onrender.com/reqbooking/${email}`);
        setBookings(response.data);
